...
try:
	...
	os.system("pip3 install httpx requests speedtest colorama");
	import speedtest
	import colorama
	import requests
	import httpx
...
class Home:
    ...
    {Color.LC}â•{Color.LB}    â•© â•â•â•â•â•â•â•©â•â•{Color.LG}v2  {Color.LG}â•‘ {Color.LB}Simple but mighty XD {Color.LG}â•‘
                        {Color.LG}â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
